    ...
    <>
      <nav className="navBar">
        <div className="leftSection">
          <a href='https://nxgentekhub.com' target={'_blank'} rel="noreferrer" style={{textDecoration: "none", outline: "none"}}>
        ...
        <div className="socialmedia" >
          <a href='https://linkedin.com' target={'_blank'} rel="noreferrer" style={{textDecoration: "none", outline: "none" }}>
     
              <img alt='' className='linkedinlogo' src='/assets/linkedin.png' />
    
          </a>

          <a href='https://instagram.com' rel="noreferrer" target={'_blank'} style={{textDecoration: "none", outline: "none" }}>

              <img alt='' className='instagramlogo' src='/assets/instagram.png'/>

          </a>
            <a href='https://facebook.com'rel="noreferrer" target={'_blank'} style={{textDecoration: "none", outline: "none" }}>
    
              <img alt='' className='facebooklogo' src='/assets/facebook.png'/>
